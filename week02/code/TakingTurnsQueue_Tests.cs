...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found:
    // ❌ FAILED – People were not re-enqueued correctly after a turn was taken.
    ...
    // Defect(s) Found: 
    // ❌ FAILED – Queue order became incorrect after adding a person midway.
    ...
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: 
    // ❌ FAILED – Infinite turns (0) were not handled correctly.
    ...
    // Defect(s) Found: 
    // ❌ FAILED – Negative turns were not treated as infinite.
    ...
    // Defect(s) Found: 
    // ❌ FAILED – Exception handling for empty queue was incorrect or missing.d
